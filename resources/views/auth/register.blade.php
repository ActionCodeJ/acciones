...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            <label for="documento" class="col-md-4 col-form-label text-md-right">{{ __('Nº de Documento') }}</label>

            <div class="col-md-6">
                <input id="documento" type="text" class="form-control" name="documento" value="{{ old('documento') }}"
                    autocomplete="documento" autofocus oninput="this.value = this.value.replace(/\D/g, '')">


                <!--<input id="documento" type="text" class="form-control" name="documento" value="{{ old('documento') }}"  autocomplete="documento" autofocus>-->
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="telefono" type="text" class="form-control" name="telefono" value="{{ old('telefono') }}"
                    autocomplete="telefono" autofocus oninput="this.value = this.value.replace(/[^0-9\-\(\) ]/g, '')">
        ...
        <div class="form-group row">
            <label for="entidad" class="col-md-4 col-form-label text-md-right">{{ __('Reparticion') }}</label>
